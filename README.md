...
To build the final jar and optimize the RtgsOutgoing application for production, run:
...
Then navigate to [http://localhost:9050](http://localhost:9050) in your browser.
